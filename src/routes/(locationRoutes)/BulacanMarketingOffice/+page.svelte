<script lang="ts">
    ...
    onMount(() => {
        ...
        const initialState = { lng: 120.96130135276128, lat: 14.735593899364904, zoom: 18 };
        ...
        .setLngLat([120.96130135276128,14.735593899364904])
        .addTo(map);
...
<main class=" text-xs sm:text-base p-4 flex flex-col gap-4" in:scale>
    <div class="mt-[30vh] sm:mt-[25vh]">
        <h2 class="h2">Location / Bulacan Marketing Office</h2>
    </div>

    <div class=" flex flex-col sm:flex-row gap-1">
        <div class="w-full">
            <img src={bulacanBanner} alt="loading" class="w-full h-[50vh]" />
        </div>
    ...
    <div class=" flex flex-col gap-4 sm:flex-row">
        <div class="flex flex-col justify-evenly gap-2 card p-4 shadow-sm shadow-black w-full" in:fly={{x:200, duration:1000}}>
            ...
            <div class="flex flex-col gap-2"> 
                <h4 class="h4 text-center">Annapolis Finance Inc Bulacan Branch</h4>
                <div class="flex gap-1">
                    <img src={addressIcon} alt="loading" class="w-6" />
                    <a href="https://www.google.com/maps/@14.7356342,120.9613068,3a,75y,54.08h,96.33t/data=!3m6!1e1!3m4!1skIuKYAGjgrEIYB8dWKjr2g!2e0!7i16384!8i8192?entry=ttu" target="_blank" class="text-base text-blue-500 underline hover:text-red-500 active:scale-95">2nd floor Lacis Bldg. Meycauayan Bualacan Landmark: Petra and Pepita Salon Meycauayan.</a>
                </div>

                <div class="flex gap-1">
                    <img src={mobilePhoneIcon} alt="loading" class="w-6" />
                    <p class="font-semibold">09265300934</p>
                </div>

                <div class="flex gap-1">
                    <img src={facebookIcon} alt="loading" class="w-6" />
                    <a href="https://www.facebook.com/AnnapolisBulTacan" target="_blank" class="text-base text-blue-500 underline hover:text-red-500 active:scale-95">Bulacan Branch Facebook Page</a>
                </div>

                <div class="flex gap-1">
                    <img src={emailIcon} alt="loading" class="w-6" />
                    <p class="font-semibold">annapolisfinancebulacan@gmail.com</p>
                </div>
            </div>
        ...
        <div class="card p-4 shadow-sm shadow-black w-full flex flex-col" in:fly={{x:-200, duration:1000}}>
            ...
            <div class="flex flex-col gap=2 p-2">
                ...
                <label>
                    <b>Message:</b>
                    <textarea class="textarea rounded-none" />
                </label>
